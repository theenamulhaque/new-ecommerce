        ...
        <div class="row">
          <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
            <div class="dashboard_content mt-2 mt-md-0">
              <h3 class="text-primary"><i class="far fa-user"></i>Vendor Profile</h3>
                        ...
                        <form action="{{ route('vendor.profile.update') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-xl-12">
                            <div class="row">
                              ...
                              <div class="col-xl-12">
                                <button class="common_btn mb-4 mt-2" type="submit">Upload Profile</button>
                              </div>
                      ...
                      <form action="{{ route('user.profile.password.update') }}" method="POST">
                        ...
                        <div class="wsus__dash_pass_change mt-2">
                          <div class="row">
                            ...
                            <div class="col-xl-12">
                              <button class="common_btn" type="submit">Upload Password</button>
                            </div>
                          </div>
                        </div>
                      </form>
