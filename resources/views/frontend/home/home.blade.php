...
@section('content')
    ...
    ==============================-->
    @include('frontend.home.monethly-top-product')
    <!--============================
    ...
    ==============================-->
    @include('frontend.home.electronic-part-1')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    ==============================-->
    @include('frontend.home.electronic-part-2')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    <!--============================
      HOME SERVICES START
    ==============================-->
    @include('frontend.home.home-service')
    <!--============================
        HOME SERVICES END
    ==============================-->
